...
test.describe("wallets and transactions", () => {
  ...
  test("recording an income transaction updates the wallet balance and shows in the list", async ({ page }) => {
  ...
  test("recording an expense transaction is reflected in the dashboard summary", async ({ page }) => {
