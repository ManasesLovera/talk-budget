...
import { Lock, Mail, User as UserIcon, Wallet } from "lucide-react-native";
      ...
      >
        <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.formCard}>
            <Text style={styles.inputLabel}>{t.register.username}</Text>
            ...
            <View style={styles.inputWrapper}>
              <Mail size={18} color="#1eb489" style={styles.inputIcon} />
              <TextInput
                value={email}
            ...
            <TouchableOpacity
              ...
              style={[styles.submitBtn, (loading || !username || !email || !password) && styles.submitBtnDisabled]}
            >
              {loading ? (
